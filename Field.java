...
public class Field {
    ...
    /**
     * Get a shuffled list of infected living neighbours
     * @param location Get locations adjacent to this.
     * @return A list of living neighbours
     */
    public List<Cell> getInfectedNeighbours(Location location) {
      ...
      if (location != null) {
        ...
        for (Location loc : adjLocations) {
          Cell cell = field[loc.getRow()][loc.getCol()];
          if (cell!= null && cell.isAlive() && cell.getDiseaseState())
            neighbours.add(cell);
        }
        Collections.shuffle(neighbours, rand);
      }
     ...
     * @return A list of living neighbours
     */
    public List<Cell> getNonInfectedNeighbours(Location location) {
